      ...
      <View style={styles.box}>
        ...
        <View style={styles.chartButtons}>
          <TouchableOpacity onPress={() => choseLang("ru")}>
            <Text style={[styles.chartButton2, language === "ru" && styles.activeButton]}>
              <Text
                style={[styles.buttonText, language === "ru" && styles.activeButtonText]}
              >
                Ru
              </Text>
            </Text>
          ...
          <TouchableOpacity onPress={() => choseLang("en")}>
            <Text style={[styles.chartButton2, language === "en" && styles.activeButton]}>
              <Text
                style={[styles.buttonText, language === "en" && styles.activeButtonText]}
              >
                En
              </Text>
            </Text>
